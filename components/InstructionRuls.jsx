      ...
      <div className="container">
        <div className="instruction-container">
            <div className="one" id="instructionOne">
                <div className="left">
                    <video width="400" height="600" controls preload="none"  style={{borderRadius : '20px'}}>
                      <source src="/Videos/secreen phone-ByA-F.mp4" type="video/mp4" />
            ...
            <div className="one" id="instructionTwo">
                ...
                <div className="left">
                <video width="400" height="600" controls preload="none" style={{borderRadius : '20px'}}>
                  <source src="/Videos/inner.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
                </div>
            </div>
            <div className="one" id="instructionThree">
                <div className="left">
                <video width="400" height="600" controls preload="none" style={{borderRadius : '20px'}}>
                  <source src="/Videos/baymethod.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
                </div>
                <div className="right">
            ...
            <div className="one">
                ...
                <div className="left">
                  <video width="400" height="600" controls preload="none"  style={{borderRadius : '20px'}}>
                    <source src="/Videos/innerform.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
            </div>
